...
def load_projects():
    ...
    return ["SK0066-AL MARJAN DCP","SK0067 - DUDP","SK0068 - 3D MODELLING (AVEVA E3D)","SK0064-CRPO78B", "SK0065-JAFURAH GCP Phase2", "SK0063- BUL HANINE PS3", "IT & Software Development", "ADMIN","HR","Business Development","Finance & Accounts","Management","SK0061-CRPO98","SK0062 - NASMATEL - MC","SK0069 - NASMATEL - AA"]
